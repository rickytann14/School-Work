...
int main(void)
{
	...
	hell.course_count=0;
	life.grade_count=0;
	loser.student_list_head = loser.student_list_tail = NULL;
	hell.course_list_head = hell.course_list_tail = NULL;
	...
	do{//Will repeat the menu in till you hit 0
		...
		switch(choice)
		{
			...
			case 2:
				...
				break;
			case 3:
				printf("Case 3 works need to finish\n");
				break;
			case 4:
				printf("Case 4 works need to finish\n");
				//(addgrades(&life, &loser, &hell));
				break;
			case 5:
				printf("Case 5 works need to finish\n");
				break;
			case 6:
				printf("Case 6 works need to finish\n");
				break;
			case 7:
				printf("Case 7 works need to finish\n");
				break;
			case 8:
				printf("\n");
				printcourses(&hell);
			...
			case 9:
				...
				break;
			case 10:
				printf("Case 10 works need to finish\n");
				break;
			case 11:
				printf("Case 11 works need to finish\n");
				break;
			case 12:
				printf("Case 12 works need to finish\n");
				break;
			default:
				while(choice>12)
				{
