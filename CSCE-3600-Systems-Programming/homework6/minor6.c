...
pthread_cond_t buff_full;	// pthread buffer full
pthread_cond_t buff_empty;	// pthread buffer empty
...
void * producer(void *arg)
{
	...
	while (1)
	{
		...
		while (1)
		{
			...
			pthread_cond_wait(&buff_full, &mutex);
...
void * consumer(void *arg)
{
	...
	while (1)
	{
		...
		while (1)
		{
			...
			pthread_mutex_lock(&mutex);
			// added
			pthread_cond_wait(&buff_empty, &mutex);
